...
declare namespace WXML {
     ...
     *
     * 实时音视频播放
     * 文档地址：https://developers.weixin.qq.com/miniprogram/dev/component/live-player.html
     */
    interface LivePlayer extends WxmlElement {
        ...
        /**
         * vertical    画面方向，
         * 可选值有 vertical，horizontal
         */
        orientation?: string;

        /**
         * contain    填充模式，
         * 可选值有 contain，fillCrop
         */
        "object-fit"?: string;
    ...
    interface LivePusher extends WxmlElement {
        ...
        /**
         * RTC    SD（标清）, HD（高清）, FHD（超清）, RTC（实时通话）
         */
        mode: string;
